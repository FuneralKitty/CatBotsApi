-- Создать роль wg_forge
DO $$ BEGIN
    CREATE ROLE wg_forge WITH LOGIN PASSWORD 'password';
EXCEPTION WHEN duplicate_object THEN
        RAISE NOTICE 'Role wg_forge already exists.';
END $$;

-- Установить роль wg_forge
SET ROLE wg_forge;

-- Создать тип cat_color
...
-- Вставить данные в таблицу cats
